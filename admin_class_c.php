    ...
    <body>
        <div class="1mainclassa">
            ...
            <div class="maincontent_form">
                <h1>Class C: Corporation<div style="text-align: left;"> <input style="width:60%" type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for first name.."></div></h1>
                <br>
