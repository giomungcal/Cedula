     ...
     <div class="adminclass">
        <div class="container_all">
          ...
          <div class="container" style="font-family: 'Montserrat';">  
               <h3 align="center" style="color: #1f4498"><b>Class C (Corporation)</b></h3>  
               <br />  
               <div class="table-responsive">  
                    <table id="class_c_data" class="table table-striped table-bordered">  
                         <?php include 'admin_class_c_table.php'; ?>
                    </table>  <br><br><br>
               </div>  
          </div>  
     </body>  
...
<script>  
setInterval(() => {
     $('#class_c_data').load("admin_class_c_table.php");
}, 1);
</script> 